...
{
    public function __construct($channel = 'PHP', $baseDir = "", $maxFiles = 7)
    {
        ...
        $logHandlers[Logger::DEBUG] = (new RotatingFileHandler($baseDir . '/logs/debug.log', $maxFiles, Logger::DEBUG))->setFormatter($formatter);
        $logHandlers[Logger::ERROR] = (new RotatingFileHandler($baseDir . '/logs/error.log', $maxFiles, Logger::ERROR, false))->setFormatter($formatter);
